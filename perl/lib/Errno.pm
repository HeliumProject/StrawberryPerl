...
"MSWin32-x64-multi-thread-10.0.18363.476" or
	die "Errno architecture (MSWin32-x64-multi-thread-10.0.18363.476) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEACCES WSAEMSGSIZE WSAENOTEMPTY WSAEHOSTUNREACH
	WSAEPROVIDERFAILEDINIT WSAECONNRESET WSAETOOMANYREFS WSAENETRESET
	WSAEOPNOTSUPP WSAEFAULT WSAECANCELLED WSAENOMORE WSAELOOP WSAEREMOTE
	WSAEREFUSED WSAEWOULDBLOCK WSAEINPROGRESS WSAESTALE WSAEPROTONOSUPPORT
	WSAEINVAL WSAEINVALIDPROCTABLE WSAEUSERS WSAEADDRINUSE WSAEHOSTDOWN
	WSAENOBUFS WSAEPFNOSUPPORT WSAEAFNOSUPPORT WSAEADDRNOTAVAIL
	WSAEPROCLIM WSAEINVALIDPROVIDER WSAECONNREFUSED WSAEDISCON WSAEALREADY
	WSAESOCKTNOSUPPORT WSAEDQUOT WSAECONNABORTED WSAEDESTADDRREQ WSAEINTR
	WSAENETUNREACH WSAEPROTOTYPE WSAESHUTDOWN WSAEMFILE WSAENOPROTOOPT
	WSAENOTSOCK WSAEISCONN WSAENAMETOOLONG WSAEBADF WSAETIMEDOUT
	WSAENOTCONN WSAENETDOWN
    )],
);
