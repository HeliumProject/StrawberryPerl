...
@EXPORT_OK = qw(ERROR_RESOURCE_ONLINE EMR_RESERVED_106
	...
	ERROR_DIR_NOT_EMPTY ERROR_OPEN_FAILED EXCEPTION_INVALID_DISPOSITION
	...
	ERROR_CLUSTER_NETWORK_EXISTS EM_GETWORDBREAKPROC ERROR_ICM_NOT_ENABLED
	...
	ERROR_CTX_MODEM_RESPONSE_ERROR ESHUTDOWN ERROR_INVALID_FLAG_NUMBER
	ERROR_DS_ATT_SCHEMA_REQ_SYNTAX ERROR_PARTIAL_COPY ERROR_IPSEC_IKE_RPC_DELETE
	...
	ERROR_SXS_UNKNOWN_ENCODING_GROUP ERROR_INVALID_MENU_HANDLE
	ERROR_IO_INCOMPLETE ERROR_DS_SERVER_DOWN ERROR_CLUSTER_NODE_ALREADY_HAS_DFS_ROOT
	...
	ERROR_FLOPPY_UNKNOWN_ERROR ERROR_EXTENDED_ERROR EM_GETMODIFY
	ERROR_NO_USER_KEYS EMARCH_ENC_I17_IMM41a_VAL_POS_X
	ERROR_CLUSTER_NODE_SHUTTING_DOWN EN_KILLFOCUS ERROR_SERVICE_MARKED_FOR_DELETE
	EXCEPTION_DATATYPE_MISALIGNMENT EMR_SETMITERLIMIT ERROR_INVALID_MESSAGEDEST
	...
	ERROR_DS_LOOP_DETECT ERROR_NOT_OWNER ERROR_NOT_JOINED
	...
	EMR_RESERVED_110 EMR_POLYLINE ERROR_INVALID_ACCEL_HANDLE
	...
	ERROR_NO_LOG_SPACE ERROR_DHCP_ADDRESS_CONFLICT ERROR_DS_NTDSCRIPT_SYNTAX_ERROR
	ERROR_DS_GC_REQUIRED ERROR_IPSEC_IKE_NEGOTIATION_PENDING
	...
	ERROR_MEDIA_CHANGED ENHANCED_KEY EVENTLOG_ERROR_TYPE
	EMARCH_ENC_I17_IC_INST_WORD_POS_X ERROR_SXS_INVALID_ACTCTXDATA_FORMAT
	...
	EMR_SELECTOBJECT ERROR_UNABLE_TO_UNLOAD_MEDIA ERROR_DS_PARENT_IS_AN_ALIAS
	ERROR_SXS_DUPLICATE_CLSID ERROR_EA_TABLE_FULL EMR_POLYBEZIERTO16
	...
	ERROR_CANTREAD EMR_SETWINDOWORGEX EVENTLOG_WARNING_TYPE
	...
	ERROR_QUORUM_RESOURCE ERROR_SERVICE_LOGON_FAILED ERROR_SET_POWER_STATE_FAILED
	ERROR_PIPE_CONNECTED EMR_SETPALETTEENTRIES EMR_TRANSPARENTBLT
	ERROR_INVALID_MESSAGE ERROR_TOKEN_ALREADY_IN_USE ERROR_INVALID_TARGET_HANDLE
	EXTTEXTOUT ERROR_TOO_MANY_MODULES ERROR_QUORUMLOG_OPEN_FAILED
	ERROR_DS_DRA_SCHEMA_CONFLICT ERROR_DS_DUP_SCHEMA_ID_GUID
	...
	EMARCH_ENC_I17_IMM41b_INST_WORD_X ERROR_TOO_MANY_CMDS
	ERROR_NO_SUCH_LOGON_SESSION EM_GETHANDLE ENUM_S_FIRST
	ERROR_SXS_PROCESS_DEFAULT_ALREADY_SET ERROR_SXS_DUPLICATE_IID
	EMARCH_ENC_I17_IMM5C_VAL_POS_X ES_LEFT ERROR_DS_NONEXISTENT_MUST_HAVE
	ERROR_DS_DECODING_ERROR ERROR_NO_SUCH_DOMAIN ERROR_IPSEC_IKE_NO_MM_POLICY
	ERROR_SXS_XML_E_DUPLICATEATTRIBUTE ENCRYPTION_FORMAT_DEFAULT
	ERROR_CONNECTED_OTHER_PASSWORD ERROR_DS_NAME_ERROR_NOT_FOUND
	EN_VSCROLL ERROR_UNABLE_TO_EJECT_MOUNTED_MEDIA EVENT_SYSTEM_MENUSTART
	EMARCH_ENC_I17_IC_SIZE_X EXCEPTION_EXECUTE_FAULT ERROR_DS_CANT_DEL_MASTER_CROSSREF
	EVENT_E_ALL_SUBSCRIBERS_FAILED ERROR_DS_DRA_ABANDON_SYNC
	ETO_NUMERICSLOCAL ERROR_INSTALL_PACKAGE_OPEN_FAILED
	ELEMENT_STATUS_NOT_BUS ERROR_INVALID_ADDRESS ES_NOHIDESEL
	...
	ERROR_MEDIA_NOT_AVAILABLE ERROR_SXS_XML_E_MISSINGWHITESPACE
	EMR_SCALEVIEWPORTEXTEX ERROR_IPSEC_IKE_PROCESS_ERR ERROR_DS_DRA_BUSY
	ExceptionContinueSearch ERROR_SXS_THREAD_QUERIES_DISABLED
	ERROR_IPSEC_IKE_QM_ACQUIRE_DROP ERROR_CLIPPING_NOT_SUPPORTED
	ERROR_INVALID_SCROLLBAR_RANGE ERROR_UNABLE_TO_LOAD_MEDIUM
	ERROR_DS_SRC_AND_DST_NC_IDENTICAL ERROR_INSTALL_REMOTE_DISALLOWED
	ERROR_MACHINE_LOCKED ERROR_IPSEC_DEFAULT_MM_POLICY_NOT_FOUND
	ERROR_NOT_ALL_ASSIGNED EPFNOSUPPORT ERROR_CONNECTION_UNAVAIL
	EVENT_OBJECT_VALUECHANGE ERROR_IPSEC_MM_FILTER_PENDING_DELETION
	...
	ERROR_BAD_ARGUMENTS ERROR_NO_WILDCARD_CHARACTERS ERROR_NOT_CONTAINER
	...
	ERROR_IPSEC_TUNNEL_FILTER_EXISTS ERROR_NO_TRUST_SAM_ACCOUNT
	ERROR_DS_SUBREF_MUST_HAVE_PARENT ELEMENT_STATUS_PVOLTAG
	ERROR_DS_ROOT_REQUIRES_CLASS_TOP EIO ERROR_SXS_XML_E_INVALID_VERSION
	ERROR_CLEANER_CARTRIDGE_INSTALLED ERROR_DS_COMPARE_TRUE
	ERROR_INDIGENOUS_TYPE ENABLE_SMART ERROR_CANT_RESOLVE_FILENAME ERROR
	ERROR_NOT_QUORUM_CLASS EMR_CREATEDIBPATTERNBRUSHPT
	ERROR_IPSEC_IKE_NO_POLICY ERROR_IS_JOIN_PATH ERROR_REMOTE_PRINT_CONNECTIONS_BLOCKED
	ERROR_BUS_RESET ERROR_IPSEC_IKE_INVALID_POLICY ERROR_BIDI_SCHEMA_NOT_SUPPORTED
	ERROR_DS_HAVE_PRIMARY_MEMBERS ERROR_IPSEC_IKE_NO_PRIVATE_KEY
	ERROR_INVALID_SIGNAL_NUMBER ERROR_ACCESS_DISABLED_WEBBLADE_TAMPER
	ERROR_DS_OBJ_CLASS_VIOLATION ESB_DISABLE_RTDN ERROR_BAD_INHERITANCE_ACL
	ERROR_IPSEC_IKE_INVALID_HEADER ERROR_BADDB ERROR_CLUSTER_DATABASE_SEQMISMATCH
	ERROR_OBJECT_IN_LIST ERROR_DIFFERENT_SERVICE_ACCOUNT
	...
	ERROR_DS_NO_SUCH_OBJECT ERROR_IPSEC_IKE_INVALID_RESPONDER_LIFETIME_NOTIFY
	...
	ERROR_IPSEC_QM_POLICY_PENDING_DELETION ERROR_SETCOUNT_ON_BAD_LB
	...
	EMARCH_ENC_I17_IMM5C_INST_WORD_POS_X EVENT_CONSOLE_START_APPLICATION
	ERROR_INVALID_INDEX EXCEPTION_WRITE_FAULT ERROR_RETRY
	...
	ERROR_ALREADY_INITIALIZED ERROR_BIDI_SCHEMA_READ_ONLY
	ERROR_SERVICE_DATABASE_LOCKED ERROR_REPARSE_ATTRIBUTE_CONFLICT
	ERROR_DS_SRC_GUID_MISMATCH EINTR ERROR_SEM_USER_LIMIT
	ERROR_DS_CONFIG_PARAM_MISSING ERROR_FILE_CORRUPT ERROR_SETMARK_DETECTED
	...
	ES_DISPLAY_REQUIRED ERROR_DS_GC_NOT_AVAILABLE ESB_DISABLE_RIGHT
	ERROR_OUT_OF_STRUCTURES ERROR_ITERATED_DATA_EXCEEDS_64k
	ERROR_OBJECT_NOT_FOUND ERROR_DS_ILLEGAL_MOD_OPERATION
	ERROR_PIPE_NOT_CONNECTED ERROR_NULL_LM_PASSWORD ERROR_CLUSTER_NODE_ALREADY_MEMBER
	...
	ERROR_DS_DRA_PREEMPTED ERROR_NO_VOLUME_LABEL ERROR_IPSEC_IKE_PEER_CRL_FAILED
	EMARCH_ENC_I17_IMM41b_SIZE_X EVENT_OBJECT_DEFACTIONCHANGE
	ERROR_DS_ROOT_MUST_BE_NC ERROR_DS_SENSITIVE_GROUP_VIOLATION
	ERROR_PRINTER_DRIVER_BLOCKED EMR_REALIZEPALETTE ERROR_NOT_SUPPORTED_ON_STANDARD_SERVER
	EMR_MAX ENOMEM ERROR_DS_CANT_DERIVE_SPN_WITHOUT_SERVER_REF
	EMR_FLATTENPATH EMR_ARC ERROR_MENU_ITEM_NOT_FOUND ERROR_CTX_SHADOW_NOT_RUNNING
	...
	ERROR_LOCKED ERROR_STATIC_INIT EM_LINESCROLL ERROR_DS_ATT_NOT_DEF_FOR_CLASS
	...
	EXIT_SUCCESS ERROR_DS_DRA_SHUTDOWN ERROR_DS_NCNAME_MUST_BE_NC
	ERROR_ACCOUNT_RESTRICTION ERROR_DS_RANGE_CONSTRAINT EUSERS
	...
	ERROR_PRINTER_DRIVER_WARNED EMR_POLYBEZIER ERROR_SEM_TIMEOUT
	...
	ERROR_NO_RECOVERY_POLICY ELEMENT_STATUS_SVALID ERROR_GROUP_NOT_AVAILABLE
	ERROR_NO_NETWORK E_PENDING ERROR_GROUP_NOT_ONLINE EPROTONOSUPPORT
	ERROR_CONTROLLING_IEPORT ERROR_SXS_UNTRANSLATABLE_HRESULT
	ENABLE_LINE_INPUT ERROR_APPHELP_BLOCK ERROR_DEPENDENCY_ALREADY_EXISTS
	...
	ERROR_IPSEC_IKE_DH_FAILURE ERROR_SXS_MANIFEST_INVALID_REQUIRED_DEFAULT_NAMESPACE
	ERROR_REMOTE_SESSION_LIMIT_EXCEEDED ERROR_DS_DUPLICATE_ID_FOUND
	EVENT_OBJECT_SELECTION ERROR_DS_NOTIFY_FILTER_TOO_COMPLEX
	EVENT_OBJECT_SHOW ERROR_EOM_OVERFLOW ERROR_QUORUM_RESOURCE_ONLINE_FAILED
	...
	ERROR_ALL_SIDS_FILTERED ERROR_SERVER_NOT_DISABLED ERROR_REDIRECTOR_HAS_OPEN_HANDLES
	ERROR_CANNOT_DETECT_DRIVER_FAILURE EM_UNDO EXCEPTION_FLT_OVERFLOW
	ERROR_IPSEC_IKE_INVALID_CERT_TYPE ERROR_INVALID_FUNCTION
	ERROR_SXS_XML_E_RESERVEDNAMESPACE ERROR_INVALID_MSGBOX_STYLE
	ERROR_CLUSCFG_SYSTEM_DISK_DRIVE_LETTER_CONFLICT ERROR_WAIT_NO_CHILDREN
	ERROR_REQ_NOT_ACCEP EMR_ROUNDRECT ERROR_NO_NET_OR_BAD_PATH
	EMR_EXTCREATEFONTINDIRECTW ERROR_INVALID_OWNER ERROR_MOD_NOT_FOUND
	ERROR_UNABLE_TO_REMOVE_REPLACED ERROR_DS_REPL_LIFETIME_EXCEEDED
	EM_SETTABSTOPS ERROR_IPSEC_IKE_UNSUPPORTED_ID EMR_POLYPOLYGON16
	ETO_CLIPPED ERROR_NO_PROC_SLOTS ERROR_SEVERITY_SUCCESS
	ERROR_BIDI_STATUS_WARNING EMR_SETPIXELV ERROR_REGISTRY_IO_FAILED
	EV_TXEMPTY EXTEND_IEPORT EV_PERR EVENT_SYSTEM_DIALOGSTART
	...
	ERROR_GROUP_EXISTS ERROR_DS_INCORRECT_ROLE_OWNER ERROR_DS_AUX_CLS_TEST_FAIL
	...
	ERROR_DS_DRA_INTERNAL_ERROR ENABLE_DISABLE_AUTO_OFFLINE
	ERROR_CLUSTER_NODE_ALREADY_UP ERROR_DS_REPLICATOR_ONLY
	...
	ERROR_DS_NO_REQUESTED_ATTS_FOUND ERROR_DS_CANT_RETRIEVE_ATTS
	EVENT_E_PER_USER_SID_NOT_LOGGED_ON ERROR_INCORRECT_ADDRESS ENOBUFS
	EMR_CREATEPALETTE ERROR_DS_WRONG_OM_OBJ_CLASS ERROR_SCOPE_NOT_FOUND
...
sub EXCEPTION_GUARD_PAGE () { 2147483649 }
sub EXCEPTION_DATATYPE_MISALIGNMENT () { 2147483650 }
sub EXCEPTION_BREAKPOINT () { 2147483651 }
sub EXCEPTION_SINGLE_STEP () { 2147483652 }
sub E_PENDING () { 2147483658 }
sub E_NOTIMPL () { 2147500033 }
sub E_NOINTERFACE () { 2147500034 }
sub E_POINTER () { 2147500035 }
sub E_ABORT () { 2147500036 }
sub E_FAIL () { 2147500037 }
sub E_UNEXPECTED () { 2147549183 }
sub E_DRAW () { 2147746112 }
sub ENUM_E_FIRST () { 2147746224 }
sub ENUM_E_LAST () { 2147746239 }
sub EVENT_E_FIRST () { 2147746304 }
sub EVENT_E_ALL_SUBSCRIBERS_FAILED () { 2147746305 }
sub EVENT_E_QUERYSYNTAX () { 2147746307 }
sub EVENT_E_QUERYFIELD () { 2147746308 }
sub EVENT_E_INTERNALEXCEPTION () { 2147746309 }
sub EVENT_E_INTERNALERROR () { 2147746310 }
sub EVENT_E_INVALID_PER_USER_SID () { 2147746311 }
sub EVENT_E_USER_EXCEPTION () { 2147746312 }
sub EVENT_E_TOO_MANY_METHODS () { 2147746313 }
sub EVENT_E_MISSING_EVENTCLASS () { 2147746314 }
sub EVENT_E_NOT_ALL_REMOVED () { 2147746315 }
sub EVENT_E_COMPLUS_NOT_INSTALLED () { 2147746316 }
sub EVENT_E_CANT_MODIFY_OR_DELETE_UNCONFIGURED_OBJECT () { 2147746317 }
sub EVENT_E_CANT_MODIFY_OR_DELETE_CONFIGURED_OBJECT () { 2147746318 }
sub EVENT_E_INVALID_EVENT_CLASS_PARTITION () { 2147746319 }
sub EVENT_E_PER_USER_SID_NOT_LOGGED_ON () { 2147746320 }
sub EVENT_E_LAST () { 2147746335 }
sub E_ACCESSDENIED () { 2147942405 }
sub E_HANDLE () { 2147942406 }
sub E_OUTOFMEMORY () { 2147942414 }
sub E_INVALIDARG () { 2147942487 }
sub ERROR_SEVERITY_ERROR () { 3221225472 }
sub EXCEPTION_ACCESS_VIOLATION () { 3221225477 }
sub EXCEPTION_IN_PAGE_ERROR () { 3221225478 }
sub EXCEPTION_INVALID_HANDLE () { 3221225480 }
sub EXCEPTION_ILLEGAL_INSTRUCTION () { 3221225501 }
sub EXCEPTION_NONCONTINUABLE_EXCEPTION () { 3221225509 }
sub EXCEPTION_INVALID_DISPOSITION () { 3221225510 }
sub EXCEPTION_ARRAY_BOUNDS_EXCEEDED () { 3221225612 }
sub EXCEPTION_FLT_DENORMAL_OPERAND () { 3221225613 }
sub EXCEPTION_FLT_DIVIDE_BY_ZERO () { 3221225614 }
sub EXCEPTION_FLT_INEXACT_RESULT () { 3221225615 }
sub EXCEPTION_FLT_INVALID_OPERATION () { 3221225616 }
sub EXCEPTION_FLT_OVERFLOW () { 3221225617 }
sub EXCEPTION_FLT_STACK_CHECK () { 3221225618 }
sub EXCEPTION_FLT_UNDERFLOW () { 3221225619 }
sub EXCEPTION_INT_DIVIDE_BY_ZERO () { 3221225620 }
sub EXCEPTION_INT_OVERFLOW () { 3221225621 }
sub EXCEPTION_PRIV_INSTRUCTION () { 3221225622 }
sub EXCEPTION_STACK_OVERFLOW () { 3221225725 }
sub ERROR_AUDITING_DISABLED () { 3221815297 }
sub ERROR_ALL_SIDS_FILTERED () { 3221815298 }
sub ERROR_UNHANDLED_ERROR () { 4294967295 }
sub ENUM_ALL_CALENDARS () { 4294967295 }
