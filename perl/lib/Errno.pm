...
"MSWin32-x64-multi-thread-4.0" or
	die "Errno architecture (MSWin32-x64-multi-thread-4.0) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
